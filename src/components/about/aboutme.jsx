    ...
    return (
        <div className="flex flex-col h-full min-w-full snap-center">
            <div className="flex flex-col h-1/6 justify-center items-start px-8">
                <h1 className="text-white text-3xl font-semibold border-b-4 border-gray-600 md:text-5xl md:py-6">About me</h1>
            </div>
            <div className="flex h-5/6 md:py-8 px-4">
                ...
                <div className="hidden lg:flex w-2/4 justify-center items-start">
