    ...
    return (
        <div className="bg-gray-900 flex flex-grow items-center justify-center">
            <div className="flex flex-col h-5/6 w-5/6 bg-gray-800 rounded-md select-none">
                ...
                <div id="aboutSlider" className="flex h-4/5 md:h-5/6 overflow-x-scroll md:scrollbar-none snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-700 scrollbar-thumb-rounded-full scrollbar-track-gray-600 scrollbar-track-rounded-full">
                    <AboutMe />
                    <Education />
                    <Skills />
                </div>
